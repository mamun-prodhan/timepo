...
const TheDials = () => {
  return (
    <div className="px-10 lg:px-48 mt-32">
      {/* the dials start */}
      <div className="flex flex-col md:flex-row-reverse items-center justify-center">
        <div className="flex-1">
          <img className="w-[200px] lg:w-[295px]" src={dial} alt="" />
        </div>
        <div className="flex-1">
          <p className="text-2xl text-center font-semibold text-[#474A59]">
            01/
          </p>
        </div>
        <div className="flex-1">
          <h2 className="mb-4 text-2xl text-[#474A59] font-semibold uppercase">
            the dials
          </h2>
          <hr className="h-0.5 w-11 bg-[#E6E6E6]" />
          <p className=" text-justify mt-10 mb-14 text-base font-normal text-[#474A59]">
          ...
          <button className="px-10 py-3 border-solid border rounded-3xl border-[#474A59] text-base font-normal uppercase text-[#3D3B3C]">
            Configure
          </button>
        </div>
      </div>
